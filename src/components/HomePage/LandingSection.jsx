      ...
      <div className="bg-silver  w-screen">
        ...
        <div className="flex flex-wrap gap-10 sm:flex-col sm:gap-4 ">
          <div className="flex flex-col justify-center items-center max-w-sm mx-auto my-8">
            <div
              style={{ backgroundImage: `url(${Mechatronic})` }}
          ...
          <div className="flex flex-col justify-center items-center max-w-sm mx-auto my-8">
            <div
              style={{ backgroundImage: `url(${CompScience})` }}
              className="bg-gray-300 h-64 w-64 rounded-lg shadow-md bg-cover bg-center"
            ></div>
            <div className="w-56 md:w-64 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden">
              <div className="py-2 text-center font-bold uppercase tracking-wide text-gray-800">
          ...
          <div className="flex flex-col justify-center items-center pb-6 mx-auto my-8 ">
            <div className="flex ">
              <img
                src={Tutor1}
                alt=""
                className="h-48 -mr-16 -mt-16 rounded-lg shadow-lg"
              />
              ...
              <div className="w-auto shadow-md  pl-24 pr-4 py-4 h-auto flex flex-col">
                <div>
                  ...
                  <p className="text-bold mb-2 text-md">
                    Mechatronic Enginnering
                  </p>
                  <p className="text-xs">
                    “The ideal engineer is a composite … He is not a scientist,
                    he is not a mathematician, he is not a sociologist or a
                    writer; but he may use the knowledge and techniques of any
                    or all of these disciplines in solving engineering
                    problems.”
                  </p>
                </div>
            ...
            <div className="flex ">
              ...
              <div className="w-auto shadow-md  pl-24 pr-4 py-4 h-auto flex flex-col">
                <div>
                  ...
                  <p className="text-xs">
                    “We need to understand that if we all work on inclusion
                    together, it’s going to be faster, broader, better, and more
                    thorough than anything we can do on our own.”
                  </p>
                </div>
                <div className="text-center pt-4 flex gap-3">
                  <img src={Whatsapp} alt="" className="h-8 " />
